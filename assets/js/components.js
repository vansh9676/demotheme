...
(function injectComponents() {
  ...
  <div id="preloader">
    <div class="preloader-inner">
      <div class="preloader-logo">Deploy<span>Stacker</span></div>
    ...
    <div class="container">
      <div class="navbar-inner">
        <a href="index.html" class="navbar-logo">
          <img src="assets/images/logo.svg" alt="DeployStacker" height="36">
        </a>
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-brand">
          <a href="index.html" class="footer-logo">Deploy<span>Stacker</span></a>
        ...
        <div class="footer-col">
          ...
          <div class="footer-contact-item">
            <i>📧</i>
            <a href="mailto:hello@deploystacker.in">hello@deploystacker.in</a>
          </div>
          <div class="footer-contact-item">
            <i>🌐</i>
            <a href="https://deploystacker.in" target="_blank">deploystacker.in</a>
          </div>
          <div class="footer-contact-item">
            <i>🕐</i>
